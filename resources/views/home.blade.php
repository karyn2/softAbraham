...
<div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <img src="{{ asset('img\conHorCla.png') }}" alt="matricula" class="icono-sidebar">
